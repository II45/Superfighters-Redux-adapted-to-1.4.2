...
internal sealed class AA12 : RWeapon
{
    internal AA12()
    {
        RWeaponProperties weaponProperties = new(93, LanguageHelper.GetText("weapon.Rifles.AA12"), 1, 8, 3, 2, -1, 600, 0, 5, 10, "ShellShotgun", 0.3f, new(12f, -2f), "MuzzleFlashShotgun", "SawedOff", "TommyGunDraw", "TommyGunReload", "OutOfAmmoHeavy", "WpnAA12", false, WeaponCategory.Primary)
        {
