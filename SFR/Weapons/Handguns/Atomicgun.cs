...
internal sealed class Atomicgun : RWeapon
{
    internal Atomicgun()
    {
        RWeaponProperties weaponProperties = new(120, LanguageHelper.GetText("weapon.Handguns.Atomicgun"), 1, 2, 0, 1, 1000, 1000, 0, 1, 111, string.Empty, 0.05f, new Vector2(12f, -2f), "MuzzleFlashShotgun", "SawedOff", "MagnumDraw", "MagnumReload", "OutOfAmmoHeavy", "WpnAtomicgun", false, WeaponCategory.Secondary)
        {
        ...
        weaponVisuals.SetModelTexture("AtomicgunM");
        weaponVisuals.SetDrawnTexture("AtomicgunD");
        weaponVisuals.SetThrowingTexture("AtomicgunThrowing");
        ...
        weaponProperties.VisualText = LanguageHelper.GetText("weapon.Handguns.Atomicgun");

        SetPropertiesAndVisuals(weaponProperties, weaponVisuals);
        CacheDrawnTextures(new[] { "Reload" });
    }

    private Atomicgun(RWeaponProperties weaponProperties, RWeaponVisuals weaponVisuals)
    {
        SetPropertiesAndVisuals(weaponProperties, weaponVisuals);
    }
    ...
    {
        Atomicgun wpnFlintlock = new(Properties, Visuals);
