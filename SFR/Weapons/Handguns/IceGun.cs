...
internal sealed class IceGun : RWeapon
{
    ...
    internal IceGun()
    {
        RWeaponProperties weaponProperties = new(121, LanguageHelper.GetText("weapon.Handguns.icegun") , "WpnIceGun", false, WeaponCategory.Secondary)
        {
            MaxMagsInWeapon = 1,
            MaxRoundsInMag = 5,
        ...
        weaponVisuals.SetModelTexture("IceGunM");
        weaponVisuals.SetDrawnTexture("IceGunD");
        weaponVisuals.SetThrowingTexture("IceGunThrowing");
        weaponVisuals.SetHolsterTexture("IceGunH");
        weaponVisuals.SetSheathedTexture("IceGunS");
        ...
        weaponProperties.VisualText = LanguageHelper.GetText("weapon.Handguns.icegun");
        SetPropertiesAndVisuals(weaponProperties, weaponVisuals);
        CacheDrawnTextures(new[] { "Reload" });
    }

    private IceGun(RWeaponProperties rwp, RWeaponVisuals rwv)
    {
    ...
    {
        IceGun IceGun = new(Properties, Visuals);
        IceGun.CopyStatsFrom(this);
        return IceGun;
    }
